...
def main(json_paths):
    ...
    for i, json_path in enumerate(json_paths):
        exercise = load_exercise(json_path)
        display_exercise(exercise, i + 1)
...
json_paths = [
    '/Users/othmane/Desktop/OTHO_CODING/Mistral_AI_Hackathon/hackaton-mistral-studai/Front/test_2/pages/draft_3.json',
    '/Users/othmane/Desktop/OTHO_CODING/Mistral_AI_Hackathon/hackaton-mistral-studai/Front/test_2/pages/draft_2.json'
